...
export const TimelineComponent = ({
  ...
  const handleChange: React.ChangeEventHandler<HTMLSelectElement> = useCallback(
    (e) => {
      onWeekdayChange(Number(e.target.value));
    },
    [onWeekdayChange],
  );
  ...
  return (
    <Stack gap={2} h="50vh">
      <NativeSelect.Root size="sm" variant="outline" width="fit-content">
        <NativeSelect.Field
      ...
      <Box h="100%" w="100%" overflowX="auto" overflowY="auto" px={4} py={2}>
